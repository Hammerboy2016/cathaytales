#!/usr/bin/env python3
"""Push pending-2026-07-03 branch via GitHub REST API.

W27 #3 搜神 · Retelling — 弦超·成公知琼 (卷一)
rotation_pointer: 3 → 4
"""
import json
import os
import re
...
POSTS = [
    {
        "path": "posts/064-the-clerk-whose-wife-came-down-from-heaven.md",
        "msg": "Add Soushen: The Clerk Whose Wife Came Down from Heaven [scheduled:16:20]",
    },
]
