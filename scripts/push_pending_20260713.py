#!/usr/bin/env python3
"""Push pending-2026-07-13 branch via GitHub REST API.

W29 #7 搜神 · Retelling — 卢充幽婚 (搜神记 · 卷十六)
rotation_pointer: 7 → 8
"""
import json
import os
import re
...
POSTS = [
    {
        "path": "posts/068-the-hunter-who-married-the-magistrates-dead-daughter.md",
        "msg": "Add Soushen: The Hunter Who Married the Magistrate's Dead Daughter [scheduled:12:50]",
    },
]
