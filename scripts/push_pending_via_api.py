#!/usr/bin/env python3
"""Push pending-2026-06-09 branch via GitHub REST API (sandbox git push blocked)."""
import json
...
BRANCH = "pending-2026-06-11"
API = "https://api.github.com"
PAT = open("/tmp/pat.txt").read().strip()

POSTS = [
    {
        "path": "posts/017-the-couple-who-became-mandarin-ducks.md",
        "msg": "Add Soushen: The Couple Who Became Mandarin Ducks [scheduled:13:23]",
    },
    {
        "path": "posts/018-the-red-umbrella-that-made-old-bones-speak.md",
        "msg": "Add Xiyuan: The Red Umbrella That Made Old Bones Speak [scheduled:16:41]",
    },
    {
        "path": "posts/019-the-country-of-two-faces.md",
        "msg": "Add Jinghuayuan: The Country Where Everyone Wore a Mask Over the Back of Their Head [scheduled:19:58]",
    },
]
