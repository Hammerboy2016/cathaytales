#!/usr/bin/env python3
"""Push pending-2026-07-10 branch via GitHub REST API.

W28 #6 唐传奇 · Translation — 杜子春 (玄怪录 · 牛僧孺)
rotation_pointer: 6 → 7
"""
import json
import os
import re
...
POSTS = [
    {
        "path": "posts/067-the-spendthrift-who-almost-became-an-immortal.md",
        "msg": "Add Tang Chuanqi: The Spendthrift Who Almost Became an Immortal [scheduled:20:56]",
    },
]
