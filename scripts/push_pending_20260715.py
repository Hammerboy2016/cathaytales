#!/usr/bin/env python3
"""Push pending-2026-07-15 branch via GitHub REST API.

W29 #8 洗冤集录 · Detective Retelling — 产后辨 (洗冤集录 · 卷四 · 妇人)
rotation_pointer: 8 → 9
"""
import json
import os
import re
...
POSTS = [
    {
        "path": "posts/069-the-mother-whose-body-had-never-given-birth.md",
        "msg": "Add Xiyuan: The Mother Whose Body Had Never Given Birth [scheduled:15:30]",
    },
]
