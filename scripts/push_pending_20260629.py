#!/usr/bin/env python3
"""Push pending-2026-06-29 branch via GitHub REST API (sandbox git push blocked).

W27 #1 起手发稿 — 阿宝 (Liaozhai vol II)，rotation_pointer #1。
"""
import json
import os
...
BRANCH = "pending-2026-06-29"
API = "https://api.github.com"
PAT = os.environ["GH_PAT"]

POSTS = [
    {
        "path": "posts/062-the-boy-who-followed-his-soul.md",
        "msg": "Add Liaozhai: The Boy Who Followed His Soul [scheduled:20:36]",
    },
]
