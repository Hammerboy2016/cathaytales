#!/usr/bin/env python3
"""Push pending-2026-07-17 branch via GitHub REST API.

W29 #9 镜花缘 · Translation — 白民国 (Jing Hua Yuan · Chapter 22)
rotation_pointer: 9 → 10
"""
import json
import os
import re
...
POSTS = [
    {
        "path": "posts/070-the-country-where-the-teacher-read-every-character-wrong.md",
        "msg": "Add Jinghuayuan: The Country Where the Teacher Read Every Character Wrong [scheduled:21:23]",
    },
]
