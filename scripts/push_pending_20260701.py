#!/usr/bin/env python3
"""Push pending-2026-07-01 branch via GitHub REST API.

W27 #2 阅微 · Translation — 李金梁梦父训 (卷九 如是我闻三)
rotation_pointer: 2 → 3
"""
import json
import os
import re
...
POSTS = [
    {
        "path": "posts/063-the-bandit-whose-father-came-back-to-warn-him.md",
        "msg": "Add Yuewei: The Bandit Whose Father Came Back From the Dead to Warn Him [scheduled:14:43]",
    },
]
