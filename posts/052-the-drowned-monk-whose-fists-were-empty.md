---
title: "The Drowned Monk Whose Fists Were Empty: A 13th-Century Chinese Forensic Test"
slug: "the-drowned-monk-whose-fists-were-empty"
date: "2026-06-25"
series: "xiyuan"
volume: "Xi Yuan Ji Lu (洗冤集录), Volume IV — Drowned Bodies (溺死)"
tale_number: 52
title_zh: "溺死真假辨：手中无草决凶手"
hub: "Karma & Retribution"
dynasty: "Song"
tags: ["forensic", "Song Ci", "Xi Yuan Ji Lu", "drowning", "Buddhist monastery", "fist clenched grass", "Song dynasty", "classical Chinese forensics", "translated", "Chinese ghost story"]
excerpt: "An old monk was found face-down in the lotus pond behind his temple. The novice who found him was already weeping. The local officer was already writing up a suicide. Song Ci took one look at the dead man's hands — closed, but empty — and asked who had been alone with him the night before."
seo_description: "A classical Chinese forensic case by Song Ci, translated: a drowned monk's empty fists open a 13th-century murder investigation."
---
...
> *A drowning man does not let go of the bottom of the pond. A corpse has nothing to hold.*[^bottom-of-pond]
...
The setting is the second courtyard of **Jingju Temple** (净居寺), a small Chan Buddhist monastery on the wooded slope above **Yongning** village, in the south of Jiangxi province.[^yongning] The temple held perhaps thirty resident monks, a long-tenured abbot, and a constant flow of lay visitors from the merchant families of the prefectural seat ten *lǐ* downhill. Behind the second courtyard was a small rectangular **lotus pond**, perhaps eight paces long and four wide, shallow enough at the edges that a child could wade in it, deep enough at the center — chest-high on a tall man — that the monks were careful to warn novices about it during the rainy season.
...
*Source: 《洗冤集录·卷之四·溺死》 — 宋·宋慈, 淳祐七年（1247年）成书. Public domain. [汉典古籍 — 洗冤集录 卷四](https://gj.zdic.net/archive.php?aid-2871.html).*
