---
title: "The Boy Who Followed His Soul: A Qing Dynasty Story of Sun Zichu and A Bao"
slug: "the-boy-who-followed-his-soul"
date: "2026-06-29"
series: "liaozhai"
volume: "Liaozhai Zhiyi (聊斋志异) — Volume II"
tale_number: 62
title_zh: "阿宝"
hub: "Love Across Death"
dynasty: "Qing"
tags: ["ghost story", "Qing dynasty", "Pu Songling", "Liaozhai", "A Bao", "Sun Zichu", "Guangxi", "classical Chinese tale", "soul wandering", "parrot transformation", "love across death"]
excerpt: "A merchant's daughter teased a clumsy scholar: cut off your sixth finger and I'll marry you. He did it with an axe. She teased again: cure your foolishness. He couldn't. Then one spring afternoon his soul walked out of his body and followed her home — and stayed three days in her bedroom as a ghost no one could see. That was only the first time he gave up his body to be near her."
seo_description: "A classical Chinese tale by Pu Songling, translated: a clumsy scholar with an extra finger gives up his body again and again — finger, soul, parrot, life — for a merchant's daughter named A Bao."
---
...
- **Sun Zichu** (孙子楚): a young scholar from Guangxi province. He was born with an extra finger ("枝指" — a sixth finger branching from one of the others, a real congenital condition). He is shy, slow of speech, and so credulous that anything you tell him he believes. His friends have nicknamed him *Sun Chī* — "Sun the Fool."
- **A Bao** (阿宝): the only daughter of a fabulously wealthy local merchant whose in-laws are nobility. She is described as 绝色 — "of unmatched beauty." She is also, when we first meet her, a teenager bored with the rich boys her father keeps trying to marry her off to.
...
They called him *Sun Chī* — *Sun the Fool*. *Chī* is the same word Pu Songling will redeem at the end of this story. For now, it is only an insult.
...
### The Historian of the Strange Remarks[^historian-of-the-strange]
...
[^chi]: 痴 (*chī*) is one of the most freighted single characters in *Liaozhai*. Pu Songling uses it about a third of his protagonists. It carries the dictionary senses of "foolish, stupid," but in Pu's vocabulary it also means *single-minded to the point of self-loss*, *unable to dissemble*, *unable to perform competence socially*. The opposite, in the *Historian of the Strange* coda, is 慧黠 (*huì xiá*) — "clever, sharp, cunning" — which Pu Songling treats as the worse condition. The argument of the coda is that conventional cleverness is the *real* foolishness.

[^zhi-zhi]: 枝指 (*zhī zhǐ*) — literally "branching finger" — is a real congenital condition, polydactyly. Premodern Chinese medical texts describe it neutrally, but in social contexts it was a minor disfigurement that excluded men from certain occupations (notably ritual ones). The detail is not symbolic in Pu Songling's tale so much as it is documentary: he is telling us that Sun Zichu has a visible flaw that has always set him apart from the rich boys he is competing with.

[^historian-of-the-strange]: 异史氏 (*Yìshǐshì* — "the Historian of the Strange") is Pu Songling's pen-name for the editorial codas at the end of many *Liaozhai* tales. He is parodying Sima Qian, who closed each chapter of the *Records of the Grand Historian* with *"the Grand Historian remarks…"*. Pu Songling was a failed civil-service candidate writing ghost stories from a small studio in Shandong; the irony of calling himself a *historian* was deliberate.

[^xiao-ke]: 消渴 (*xiāo kě*) — literally "wasting-thirst" — is the classical Chinese medical name for what we now call diabetes mellitus. Late imperial physicians recognized the characteristic symptoms (unquenchable thirst, weight loss, sweet-smelling urine) and considered it a disease of yin depletion and internal heat. In Pu Songling's day it was often, though not always, fatal.

[^hanlin]: 词林 (*cílín* — "Forest of Words") is a poetic name for the Hanlin Academy (翰林院), the elite imperial body of scholar-officials that drafted court documents, tutored princes, and produced official histories. Appointment to the Hanlin was the highest civilian honor a successful examination candidate could receive — and one Pu Songling himself, despite forty years of trying, never came close to.
...
*Source: 《聊斋志异·卷二·阿宝》— 清·蒲松龄. Public domain. [古文岛 m.gushiwen.cn](https://m.gushiwen.cn/guwen/bookv_95882c22ec17.aspx).*
