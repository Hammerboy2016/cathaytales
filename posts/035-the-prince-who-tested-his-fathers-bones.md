---
title: "The Prince Who Tested His Father's Bones with a Drop of His Own Blood: A Forensic Test from 6th-Century China"
slug: "the-prince-who-tested-his-fathers-bones"
date: "2026-06-18"
series: "xiyuan"
volume: "Xi Yuan Ji Lu (洗冤集录), Volume IV — Verifying Kinship by Drop-Blood (滴骨亲法)"
tale_number: 35
title_zh: "萧综验滴骨亲"
hub: "Karma & Retribution"
dynasty: "Six Dynasties"
tags: ["forensic", "Song Ci", "Xi Yuan Ji Lu", "drop-blood test", "Liang dynasty", "Xiao Zong", "Xiao Baojuan", "Six Dynasties", "kinship verification", "classical Chinese forensics"]
excerpt: "A prince of the Liang dynasty grew up suspecting that his real father was the dead emperor his stepfather had overthrown. He stole into a sealed tomb at midnight and tested the bones with a drop of his own blood. What he did next, to be sure, is the part the historians could not unwrite."
seo_description: "A classical Chinese forensic case by Song Ci, translated: a prince tests his father's bones with his own blood — and the body of his own son."
---
...
In Volume IV of *The Washing Away of Wrongs*, under the entry **Verifying Kinship by Drop-Blood** (验滴骨亲法), Song Ci — the 13th-century forensic magistrate who effectively founded the field of medico-legal investigation in China — sets out the test in a single short paragraph:[^songci]
...
Song Ci is a careful empiricist by the standards of any century. He notes immediately afterward that the test does not always work — old bones, weathered bones, bones that have been washed by rain, bones that have been lacquered, all behave differently. He gives the test as a tool, not a verdict.[^methodlimits]
...
What he did, according to the *Liang Shu* (梁书, *Book of Liang*) and the *Nan Shi* (南史, *History of the Southern Dynasties*) — both of which Song Ci treats as authoritative sources for the case — was wait.[^liangshu]
...
<summary>⚠️ <strong>Content Warning</strong> — graphic violence against an infant (click to reveal)</summary>
...
*Sources: 《洗冤集录·卷三·验滴骨亲》— 宋·宋慈（1247年成书）— [识典古籍 · 洗冤集录卷三](https://www.shidianguji.com/zh/book/CADAL02092495/chapter/1l5i86j57sdu7) · [人民网·宋慈如何断案 引宋慈原文](http://m.people.cn/n4/2016/0617/c679-7052635.html). 《南史·卷五十三·梁武帝诸子·豫章王综传》— 唐·李延寿（659年成书）— [古诗文网 · 南史卷五十三](https://m.gushiwen.cn/guwen/bookv_826438a7b9a6.aspx). Both texts are public domain.*
