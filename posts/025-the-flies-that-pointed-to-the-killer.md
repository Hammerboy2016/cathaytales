---
title: "The Flies That Pointed to the Killer: A 13th-Century Chinese Forensic Case"
slug: "the-flies-that-pointed-to-the-killer"
date: "2026-06-14"
series: "xiyuan"
volume: "Xi Yuan Ji Lu, Volume II — Difficult and Doubtful Cases (疑难杂说下), Case 6"
case_number: 3
title_zh: "蝇验镰：宋慈让一群苍蝇指认凶手"
hub: "Karma & Retribution"
dynasty: "Song"
tags: ["forensic science", "Song dynasty", "true crime", "Song Ci", "entomology", "Chinese forensics", "history of CSI", "cold case", "blood evidence"]
excerpt: "A peasant lies dead in a country lane with a dozen sickle-cuts on his body and his coin-purse untouched. The local coroner orders every household within a li to bring out their sickles. He lays seventy of them in a row in the summer sun — and waits for the flies to choose."
seo_description: "A classical Chinese forensic case by Song Ci, translated: a Song dynasty coroner laid out 70 sickles in the sun — flies picked the killer's blade."
---
...
*"Go to every household within a li of this field,"* he told the constables. *"Tell them the magistrate's office is collecting all of the sickles in the hamlet for inspection. Every household must bring every sickle they own. Anyone who hides a sickle, or claims to own none when the neighbors say they do, will be presumed the killer. Make sure they understand that part."*[^song-ci-procedure]
...
*Source: 宋慈《洗冤集录·卷二·疑难杂说下》第六则，南宋淳祐七年（1247）成书. Public domain. Full text via [古诗文网 / 古文岛 m.gushiwen.cn](https://m.gushiwen.cn/guwen/bookv_e4aabba1dbd2.aspx).*
...
- The full text is in the public domain and available online via [古诗文网](https://m.gushiwen.cn/guwen/book_b9eb054ed3e2.aspx) and the [Chinese Text Project (ctext.org)](https://ctext.org/wiki.pl?if=gb&res=87993).
